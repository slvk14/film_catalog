...
ActiveRecord::Schema.define(version: 20_191_027_125_237) do
  ...
  create_table 'watch_later_movies', force: :cascade do |t|
    t.bigint 'user_id'
    t.bigint 'movie_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['movie_id'], name: 'index_watch_later_movies_on_movie_id'
    t.index ['user_id'], name: 'index_watch_later_movies_on_user_id'
  end
